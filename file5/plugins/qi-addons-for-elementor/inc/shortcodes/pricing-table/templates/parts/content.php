...
if ( isset( $items ) && count( $items ) ) {
	?>
	<<?php echo qi_addons_for_elementor_framework_sanitize_tags( $list_tag ); ?> class="qodef-m-content">
		<?php
		...
		<?php } ?>
	</<?php echo qi_addons_for_elementor_framework_sanitize_tags( $list_tag ); ?>>
<?php } ?>
