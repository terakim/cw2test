...
<style>
    ...
    .pafw-review-wrapper > input[type=checkbox]:checked:before {
        ...
        width: 9px;
        height: 9px;
        background: url("<?php echo PAFW()->plugin_url() . '/assets/images/rating/white/check.png'; ?>") center center !important;
		...
		<?php foreach ( $rate_options as $rate_option ) : ?>
            <div class="pafw-smart-reivew-item">
                ...
                <label for="pafw_smart_review_rate<?php echo $rate_option['rate']; ?>">
                    <img src="<?php echo PAFW()->plugin_url() . '/assets/images/rating/white/' . $rate_option['rate'] . '.png'; ?>" style="height: 15px; vertical-align: middle;"/>
                    <span style="padding-left: 6px; vertical-align: middle;"><?php echo $rate_option['label']; ?></span>
                </label>
            </div>
		<?php endforeach; ?>
