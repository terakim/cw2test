...
<div class="pafw-card pafw-<?php echo $master_id; ?>">
    ...
    <div class="pafw_card_form" style="display: none;">
        <form>
            ...
            <div class="tosspayments-register-card pafw-register-custom-handler" data-payment_method="<?php echo $payment_gateway->id; ?>"><?php _e( "등록하기", "pgall-for-woocommerce" ); ?></div>
        </form>
    </div>
</div>
