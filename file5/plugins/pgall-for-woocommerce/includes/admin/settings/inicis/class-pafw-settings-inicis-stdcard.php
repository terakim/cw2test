...
if ( ! class_exists( 'PAFW_Settings_Inicis_Stdcard' ) ) {
	class PAFW_Settings_Inicis_Stdcard extends PAFW_Settings_Inicis {
			...
			return array (
				array (
					...
					'elements' => array (
						...
						array (
							'id'        => 'inicis_stdcard_use_nointerest',
						...
						array (
							'id'        => 'inicis_stdcard_nointerest',
							'title'     => __( '무이자 할부 설정', 'pgall-for-woocommerce' ),
							'showIf'    => array ( 'inicis_stdcard_use_nointerest' => 'yes' ),
							'className' => 'fluid',
							'type'      => 'Text',
							'default'   => '',
							'tooltip'   => array (
				...
				array (
					...
					'elements' => array (
						array (
							'id'        => 'inicis_stdcard_use_advanced_setting',
							'title'     => '사용',
							'className' => '',
							'type'      => 'Toggle',
							'default'   => 'no',
						...
						array (
							'id'        => 'inicis_stdcard_order_status_after_payment',
							'title'     => __( '결제완료시 변경될 주문상태', 'pgall-for-woocommerce' ),
							'showIf'    => array ( 'inicis_stdcard_use_advanced_setting' => 'yes' ),
							'className' => '',
							'type'      => 'Select',
							'default'   => 'processing',
						...
						array (
							'id'        => 'inicis_stdcard_possible_refund_status_for_mypage',
