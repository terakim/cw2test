...
if ( ! class_exists( 'PAFW_Settings_Inicis_Stdsamsungpay' ) ) {
	class PAFW_Settings_Inicis_Stdsamsungpay extends PAFW_Settings_Inicis {
			...
			return array (
				array (
					...
					'elements' => array (
						...
						array (
							'id'        => 'inicis_stdsamsungpay_description',
							'title'     => '결제수단 설명',
							'className' => 'fluid',
							'type'      => 'TextArea',
							'default'   => __( '삼성페이 간편 결제를 진행합니다.', 'pgall-for-woocommerce' ),
							'tooltip'   => array (
								'title' => array (
						...
						array (
							'id'        => 'inicis_stdsamsungpay_quotabase',
						...
						array (
							'id'        => 'inicis_stdsamsungpay_use_nointerest',
						...
						array (
							'id'        => 'inicis_stdsamsungpay_nointerest',
							'title'     => __( '무이자 할부 설정', 'pgall-for-woocommerce' ),
							'showIf'    => array ( 'inicis_stdsamsungpay_use_nointerest' => 'yes' ),
							'className' => 'fluid',
							'type'      => 'Text',
							'default'   => '',
							'tooltip'   => array (
						...
						array (
							'id'        => 'inicis_stdsamsungpay_cardpoint',
				...
				array (
					...
					'elements' => array (
						array (
							'id'        => 'inicis_stdsamsungpay_use_advanced_setting',
							'title'     => '사용',
							'className' => '',
							'type'      => 'Toggle',
							'default'   => 'no',
						...
						array (
							'id'        => 'inicis_stdsamsungpay_order_status_after_payment',
							'title'     => __( '결제완료시 변경될 주문상태', 'pgall-for-woocommerce' ),
							'showIf'    => array ( 'inicis_stdsamsungpay_use_advanced_setting' => 'yes' ),
							'className' => '',
							'type'      => 'Select',
							'default'   => 'processing',
						...
						array (
							'id'        => 'inicis_stdsamsungpay_possible_refund_status_for_mypage',
