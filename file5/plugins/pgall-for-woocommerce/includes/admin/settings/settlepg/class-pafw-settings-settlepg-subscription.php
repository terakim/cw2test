...
if ( ! class_exists( 'PAFW_Settings_Settlepg_Subscription' ) ) {

	class PAFW_Settings_Settlepg_Subscription extends PAFW_Settings_SettlePG {
		...
		function get_setting_fields() {
			return array (
				array (
					...
					'elements' => array (
						array (
							'id'        => 'settlepg_subscription_title',
							'title'     => '결제수단 이름',
							'className' => 'fluid',
							'type'      => 'Text',
							'default'   => '신용카드 정기결제',
						...
						array (
							'id'        => 'settlepg_subscription_description',
							'title'     => '결제수단 설명',
							'className' => 'fluid',
							'type'      => 'TextArea',
						...
						array (
							'id'        => 'settlepg_subscription_enable_quota',
