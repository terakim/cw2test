...
if ( ! class_exists( 'PAFW_Settings_Nicepay_Vbank' ) ) {

	class PAFW_Settings_Nicepay_Vbank extends PAFW_Settings_Nicepay {
			...
			return array (
				array (
					...
					'elements' => array (
						...
						array (
							'id'        => 'nicepay_vbank_order_vbank_noti_url_new',
				...
				array (
					...
					'elements' => array (
						array (
							'id'        => 'nicepay_vbank_use_advanced_setting',
							'title'     => '사용',
							'className' => '',
							'type'      => 'Toggle',
							'default'   => 'no',
						...
						array (
							'id'        => 'nicepay_vbank_order_status_after_vbank_payment',
							'showIf'    => array ( 'nicepay_vbank_use_advanced_setting' => 'yes' ),
						...
						array (
							'id'        => 'nicepay_vbank_order_status_after_payment',
							'showIf'    => array ( 'nicepay_vbank_use_advanced_setting' => 'yes' ),
						...
						array (
							'id'        => 'nicepay_vbank_possible_refund_status_for_mypage',
							'showIf'    => array ( 'nicepay_vbank_use_advanced_setting' => 'yes' ),
