...
if ( ! class_exists( 'PAFW_Settings_TossPayments_Escrow_Bank' ) ) {

	class PAFW_Settings_TossPayments_Escrow_Bank extends PAFW_Settings_TossPayments {
		...
		function get_setting_fields() {
			return array (
				array (
					...
					'elements' => array (
						array (
							'id'        => 'tosspayments_escrow_bank_title',
							'title'     => '결제수단 이름',
							'className' => 'fluid',
							'type'      => 'Text',
						...
						array (
							'id'        => 'tosspayments_escrow_bank_description',
							'title'     => '결제수단 설명',
							'className' => 'fluid',
							'type'      => 'TextArea',
						...
						array (
							'id'        => 'tosspayments_escrow_bank_receipt',
				...
				array (
					...
					'elements' => array (
						array (
							'id'        => 'tosspayments_escrow_bank_delivery_company_name',
							'title'     => '택배사명',
							'className' => '',
							'type'      => 'Text',
							'placeholder'   => '일반택배'
						...
						array (
							'id'        => 'tosspayments_escrow_bank_delivery_register_name',
							'title'     => '등록자명',
							'className' => '',
							'type'      => 'Text',
							'placeholder'   => '홍길동'
						...
						array (
							'id'        => 'tosspayments_escrow_bank_delivery_sender_phone',
							'title'     => '전화번호',
							'className' => '',
							'type'      => 'Text',
				...
				array (
					...
					'elements' => array (
						array (
							'id'        => 'tosspayments_escrow_bank_use_advanced_setting',
							'title'     => '사용',
							'className' => '',
							'type'      => 'Toggle',
							'default'   => 'no',
						...
						array (
							'id'        => 'tosspayments_escrow_bank_order_status_after_payment',
							'title'     => __( '결제완료시 변경될 주문상태', 'pgall-for-woocommerce' ),
							'showIf'    => array ( 'tosspayments_escrow_bank_use_advanced_setting' => 'yes' ),
							'className' => '',
							'type'      => 'Select',
							'default'   => 'processing',
						...
						array (
							'id'        => 'tosspayments_escrow_bank_order_status_after_enter_shipping_information',
						...
						array (
							'id'        => 'tosspayments_escrow_bank_possible_refund_status_for_mypage',
						...
						array (
							'id'        => 'tosspayments_escrow_bank_possible_escrow_confirm_status_for_customer',
