...
if ( ! class_exists( 'PAFW_Settings_TossPayments_Vbank' ) ) {

	class PAFW_Settings_TossPayments_Vbank extends PAFW_Settings_TossPayments {
			...
			return array (
				array (
					...
					'elements' => array (
						...
						array (
							'id'        => 'tosspayments_vbank_description',
							'title'     => '결제수단 설명',
							'className' => 'fluid',
							'type'      => 'TextArea',
						...
						array (
							'id'        => 'tosspayments_vbank_order_vbank_noti_url',
							'title'     => __( '입금통보 URL', 'pgall-for-woocommerce' ),
							'className' => '',
							'type'      => 'Label',
							'readonly'  => 'yes',
							'desc2'     => __( '<code>' . untrailingslashit( WC()->api_request_url( 'WC_Gateway_TossPayments_Vbank?type=vbank_noti', pafw_check_ssl() ) ) . '</code><div class="desc2">가상계좌 무통장입금 내역 통보에 사용되는 URL 주소입니다.<br>가상계좌 무통장입금 매뉴얼을 참고하여 토스페이먼츠 가맹점 관리자 페이지에 접속하여 주소를 입력하여 주시기 바랍니다.</div>', 'pgall-for-woocommerce' ),
						),
						array (
							"id"        => "tosspayments_vbank_account_date_limit",
							"title"     => "가상계좌 입금기한",
							"className" => "",
							"type"      => "LabeledInput",
							'inputType' => 'number',
				...
				array (
					...
					'elements' => array (
						array (
							'id'        => 'tosspayments_vbank_use_advanced_setting',
							'title'     => __( '사용', 'pgall-for-woocommerce' ),
							'className' => '',
							'type'      => 'Toggle',
							'default'   => 'no',
							'tooltip'   => array (
						...
						array (
							'id'        => 'tosspayments_vbank_order_status_after_vbank_payment',
							'title'     => __( '주문접수시 변경될 주문상태', 'pgall-for-woocommerce' ),
							'showIf'    => array ( 'tosspayments_vbank_use_advanced_setting' => 'yes' ),
							'className' => '',
							'type'      => 'Select',
							'default'   => 'on-hold',
						...
						array (
							'id'        => 'tosspayments_vbank_order_status_after_payment',
						...
						array (
							'id'        => 'tosspayments_vbank_possible_refund_status_for_mypage',
