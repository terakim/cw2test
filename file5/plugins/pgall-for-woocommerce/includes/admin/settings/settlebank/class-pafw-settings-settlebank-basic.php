				...
				array (
					...
					'elements' => array (
						...
						array (
							...
							'type'      => 'Text',
							'default'   => '',
							'desc2'     => __( '<div class="desc2">핵토파이낸셜 가입 후 전달받으신 개인정보 암호키를 입력해주세요.<br>결제 테스트를 위한 가맹점 인증키 발급은 <code><a target="_blank" href="https://develop.sbsvc.online/">핵토파이낸셜 개발자 사이트</a></code>에서 신청하실 수 있습니다.</code></div>', 'pgall-for-woocommerce' ),
						),
					)
				),
				array (
