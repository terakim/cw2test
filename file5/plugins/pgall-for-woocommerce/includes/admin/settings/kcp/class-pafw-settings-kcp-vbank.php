...
if ( ! class_exists( 'PAFW_Settings_Kcp_Vbank' ) ) {
	class PAFW_Settings_Kcp_Vbank extends PAFW_Settings_Kcp {
			...
			return array (
				array (
					...
					'elements' => array (
						...
						array (
							'id'        => 'kcp_vbank_order_vbank_noti_url',
				...
				array (
					...
					'elements' => array (
						array (
							'id'        => 'kcp_vbank_use_advanced_setting',
							'title'     => '사용',
							'className' => '',
							'type'      => 'Toggle',
							'default'   => 'no',
						...
						array (
							'id'        => 'kcp_vbank_order_status_after_vbank_payment',
							'title'     => __( '주문접수시 변경될 주문상태', 'pgall-for-woocommerce' ),
							'showIf'    => array ( 'kcp_vbank_use_advanced_setting' => 'yes' ),
							'className' => '',
							'type'      => 'Select',
							'default'   => 'on-hold',
						...
						array (
							'id'        => 'kcp_vbank_order_status_after_payment',
						...
						array (
							'id'        => 'kcp_vbank_possible_refund_status_for_mypage',
