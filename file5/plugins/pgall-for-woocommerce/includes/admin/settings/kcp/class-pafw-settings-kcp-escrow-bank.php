...
if ( ! class_exists( 'PAFW_Settings_Kcp_Escrow_Bank' ) ) {
	class PAFW_Settings_Kcp_Escrow_Bank extends PAFW_Settings_Kcp {
			...
			return array (
				array (
					...
					'elements' => array (
						...
						array (
							'id'        => 'kcp_escrow_bank_description',
						...
						array (
							'id'        => 'kcp_escrow_bank_disp_tax_yn',
				...
				array (
					...
					'elements' => array (
						array (
							'id'          => 'kcp_escrow_bank_delivery_register_name',
						...
						array (
							'id'          => 'kcp_escrow_bank_delivery_company_name',
							'title'       => __( '택배사명', 'pgall-for-woocommerce' ),
							'className'   => 'fluid',
							'type'        => 'Text',
							'placeholder' => __( '일반택배', 'pgall-for-woocommerce' )
						)
					)
				),
				array (
					...
					'elements' => array (
						array (
							'id'        => 'kcp_escrow_bank_use_advanced_setting',
							'title'     => '사용',
							'className' => '',
							'type'      => 'Toggle',
							'default'   => 'no',
						...
						array (
							'id'        => 'kcp_escrow_bank_order_status_after_payment',
							'showIf'    => array ( 'kcp_escrow_bank_use_advanced_setting' => 'yes' ),
						...
						array (
							'id'        => 'kcp_escrow_bank_order_status_after_enter_shipping_number',
							'showIf'    => array ( 'kcp_escrow_bank_use_advanced_setting' => 'yes' ),
						...
						array (
							'id'        => 'kcp_escrow_bank_possible_refund_status_for_mypage',
							'showIf'    => array ( 'kcp_escrow_bank_use_advanced_setting' => 'yes' ),
						...
						array (
							'id'        => 'kcp_escrow_bank_possible_escrow_confirm_status_for_customer',
							'showIf'    => array ( 'kcp_escrow_bank_use_advanced_setting' => 'yes' ),
