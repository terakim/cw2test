...
if ( ! class_exists( 'PAFW_Settings_Lguplus_Bank' ) ) {

	class PAFW_Settings_Lguplus_Bank extends PAFW_Settings_Lguplus {
		...
		function get_setting_fields() {
			return array (
				...
				array (
					...
					'elements' => array (
						array (
							'id'        => 'lguplus_bank_use_advanced_setting',
							'title'     => '사용',
							'className' => '',
							'type'      => 'Toggle',
							'default'   => 'no',
						...
						array (
							'id'        => 'lguplus_bank_order_status_after_payment',
							'title'     => __( '결제완료시 변경될 주문상태', 'pgall-for-woocommerce' ),
							'showIf'    => array ( 'lguplus_bank_use_advanced_setting' => 'yes' ),
							'className' => '',
							'type'      => 'Select',
							'default'   => 'processing',
						...
						array (
							'id'        => 'lguplus_bank_possible_refund_status_for_mypage',
