...
if ( ! class_exists( 'PAFW_Settings_Lguplus_Subscription' ) ) {

	class PAFW_Settings_Lguplus_Subscription extends PAFW_Settings_Lguplus {
			...
			return array (
				array (
					...
					'elements' => array (
						...
						array (
							'id'        => 'lguplus_subscription_description',
							'title'     => '결제수단 설명',
							'className' => 'fluid',
							'type'      => 'TextArea',
						...
						array (
							'id'        => 'lguplus_subscription_enable_quota',
						...
						array (
							'id'        => 'lguplus_subscription_quota',
							'title'     => __( '할부 개월수', 'pgall-for-woocommerce' ),
							'showIf'    => array ( 'lguplus_subscription_enable_quota' => 'yes' ),
							'className' => '',
							'type'      => 'Select',
							'default'   => '',
							'multiple'  => true,
				...
				array (
					...
					'elements' => array (
						array (
							'id'        => 'lguplus_subscription_use_advanced_setting',
							'title'     => '사용',
							'className' => '',
							'type'      => 'Toggle',
							'default'   => 'no',
						...
						array (
							'id'        => 'lguplus_subscription_order_status_after_payment',
							'title'     => __( '결제완료시 변경될 주문상태', 'pgall-for-woocommerce' ),
							'showIf'    => array ( 'lguplus_subscription_use_advanced_setting' => 'yes' ),
							'className' => '',
							'type'      => 'Select',
							'default'   => 'processing',
						...
						array (
							'id'        => 'lguplus_subscription_possible_refund_status_for_mypage',
