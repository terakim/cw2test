...
if ( ! class_exists( 'PAFW_Settings_Lguplus_Card' ) ) {

	class PAFW_Settings_Lguplus_Card extends PAFW_Settings_Lguplus {
			...
			return array (
				array (
					...
					'elements' => array (
						...
						array (
							'id'        => 'lguplus_card_quota_interest',
							'title'     => __( '무이자 할부개월 설정', 'pgall-for-woocommerce' ),
							'showIf'    => array ( 'lguplus_card_shopinterest' => 'yes' ),
							'className' => 'fluid',
							'type'      => 'Text',
							'default'   => '',
							'tooltip'   => array (
				...
				array (
					...
					'elements' => array (
						array (
							'id'        => 'lguplus_card_use_advanced_setting',
							'title'     => '사용',
							'className' => '',
							'type'      => 'Toggle',
							'default'   => 'no',
						...
						array (
							'id'        => 'lguplus_card_order_status_after_payment',
							'title'     => __( '결제완료시 변경될 주문상태', 'pgall-for-woocommerce' ),
							'showIf'    => array ( 'lguplus_card_use_advanced_setting' => 'yes' ),
							'className' => '',
							'type'      => 'Select',
							'default'   => 'processing',
						...
						array (
							'id'        => 'lguplus_card_possible_refund_status_for_mypage',
