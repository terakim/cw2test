...
if ( ! class_exists( 'PAFW_Settings_Lguplus_Vbank' ) ) {

	class PAFW_Settings_Lguplus_Vbank extends PAFW_Settings_Lguplus {
			...
			return array (
				array (
					...
					'elements' => array (
						...
						array (
							'id'        => 'lguplus_vbank_order_vbank_noti_url',
				...
				array (
					...
					'elements' => array (
						array (
							'id'        => 'lguplus_vbank_use_advanced_setting',
						...
						array (
							'id'        => 'lguplus_vbank_order_status_after_vbank_payment',
							'title'     => __( '주문접수시 변경될 주문상태', 'pgall-for-woocommerce' ),
							'showIf'    => array ( 'lguplus_vbank_use_advanced_setting' => 'yes' ),
							'className' => '',
							'type'      => 'Select',
							'default'   => 'on-hold',
						...
						array (
							'id'        => 'lguplus_vbank_order_status_after_payment',
						...
						array (
							'id'        => 'lguplus_vbank_possible_refund_status_for_mypage',
