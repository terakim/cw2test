...
if ( class_exists( 'WC_Payment_Gateway' ) ) {
	...
	if ( ! class_exists( 'WC_Gateway_TossPayments_Escrow_Bank' ) ) {

		class WC_Gateway_TossPayments_Escrow_Bank extends WC_Gateway_TossPayments {
			public function __construct() {
				$this->id = 'tosspayments_escrow_bank';

				parent::__construct();

				$this->method_title = __( '실시간 계좌이체 (에스크로)', 'pgall-for-woocommerce' );
