	...
	class MSPS_Settings_Point_Logs {
		...
		public function get_setting_fields() {
			return array(
				...
				'id'           => 'mshop_point_log',
				'searchConfig' => array(
					'action'           => msps_ajax_command( 'admin_point_logs' ),
					'pageSize'         => self::$number_per_page,
					'deleteItem'       => true,
					'deleteItemAction' => msps_ajax_command( 'delete_log_items' )
				),
				'elements'     => array(
					array(
						...
						'elements'          => array(
							array(
								...
								'multiple'    => true,
								'search'      => true,
								'action'      => mshop_wpml_get_default_language_args() . 'action=' . msps_ajax_command( 'mshop_point_search_user&keyword=' ),
								"type"        => "SearchSelect",
								'options'     => array()
							),
							array(
							...
							array(
								...
								'args'       => array(
									...
									'action'  => msps_ajax_command( 'export_logs' )
								)
							),
						)
					),
