    ...
    class MSPS_Settings_Manage_Point {
        ...
        public function get_setting_fields() {
	        return array (
		        ...
		        'searchConfig' => array (
			        'action'   => msps_ajax_command( 'get_user_point_list' ),
			        ...
			        array (
				        ...
				        'elements'          => array (
					        array (
						        ...
						        'multiple'    => true,
						        'search'      => true,
						        'action'      => mshop_wpml_get_default_language_args() . 'action=' . msps_ajax_command( 'mshop_point_search_user' ),
						        "type"        => "SearchSelect",
						        'options'     => array ()
					        ),
					        array (
					        ...
					        array (
						        ...
						        'default'    => '',
						        'actionType' => 'ajax',
						        'ajaxurl'    => add_query_arg( 'lang', mshop_wpml_get_default_language(), admin_url( 'admin-ajax.php' ) ),
						        'action'     => msps_ajax_command( 'export_users' ),
					        )
				        )
			        ),
			        array (
				        ...
				        'elements'          => apply_filters( 'msps_batch_action_settings',
					        array (
						        array (
							        ...
							        'action'       => msps_ajax_command( 'batch_adjust_point' )
						        ),
					        ...
					        "elements"    => apply_filters( 'msps_manage_point_settings',
						        array (
							        ...
							        array (
								        ...
								        'custom_event' => 'mshop_manage_point',
								        'action'       => msps_ajax_command( 'adjust_mshop_user_point' )
							        ),
							        array (
								        "id"        => "last_date",
