...
<div class="send-no-guide">
    ...
    <p class="send-no-guide-content">- 알림톡 발송 템플릿 작성시 사용되는 대체 문구에 대한 설명입니다.</p>
    <p class="send-no-guide-content">- 아래 내용을 참고하여 대체 문구를 설정하여 이용할 수 있습니다.</p>
    <hr>
    <p class="send-no-guide-title">[2] 알림톡 발송시</p>
    ...
    <p class="send-no-guide-content">- #{주문번호} : 해당 주문건의 주문번호가 표시됩니다. 예 : 1234</p>
    <p class="send-no-guide-content">- #{주문금액} : 해당 주문건의 주문금액이 표시됩니다. 예 : 1,000</p>
    ...
    <p class="send-no-guide-content">- #{인증번호} : 엠샵 멤버스 플러그인의 휴대폰 인증 기능 사용시, 인증번호가 표시됩니다..</p>
    <hr>
	...
	<?php endif; ?>
	<?php if ( class_exists( 'MShop_Point' ) ) : ?>
        <hr>
        <p class="send-no-guide-title">[포인트 소멸 알림 전용]</p>
        <p class="send-no-guide-content">- 포인트 소멸 알림 대체문자는 "<a href="/wp-admin/admin.php?page=mshop_point_extinction" target="_blank">엠샵 포인트 => 포인트 소멸 설정</a>"에만 적용됩니다.</p>
        <p class="send-no-guide-content">- #{소멸예정포인트} : 정기결제권 번호가 표시됩니다.</p>
        <p class="send-no-guide-content">- #{소멸예정일} : 정기결제 신청일자가 표시됩니다.</p>
        <p class="send-no-guide-content"><b>* (주의) 포인트 소멸 알림에만 적용됩니다.</b></p>
	<?php endif; ?>
	<?php if ( class_exists( 'MSHOP_Coupon' ) ) : ?>
        <hr>
        <p class="send-no-guide-title">[쿠폰 선물 알림 전용]</p>
        <p class="send-no-guide-content">- #{쿠폰번호} : 쿠폰번호가 표시됩니다.</p>
        <p class="send-no-guide-content">- #{사용기한} : 쿠폰 사용기한이 표시됩니다.</p>
        <p class="send-no-guide-content"><b>* (주의) 쿠폰 선물 알림에만 적용됩니다.</b></p>
	<?php endif; ?>
</div>