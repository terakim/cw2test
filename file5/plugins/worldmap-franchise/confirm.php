<div id="kboard-worldmap-franchise-editor" class="confirm">
	<form method="post" action="<?php echo esc_url($url->getConfirmExecute($content->uid))?>">
		...
		<div class="kboard-control">
			<div class="left">
				...
				<a href="<?php echo esc_url($url->getDocumentURLWithUID($content->uid))?>" class="kboard-worldmap-franchise-button-small" title="<?php echo __('Document', 'kboard')?>"><?php echo __('Document', 'kboard')?></a>
				<?php endif?>
				<a href="<?php echo esc_url($url->getBoardList())?>" class="kboard-worldmap-franchise-button-small" title="<?php echo __('List', 'kboard')?>"><?php echo __('List', 'kboard')?></a>
			</div>
			<div class="right">
