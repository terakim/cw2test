...
if ( ! class_exists( 'MSM_Setting_Helper' ) ) {
	Class MSM_Setting_Helper {
		...
		public static function get_editable_roles( $filter_name = null ) {
			...
			if ( empty( $filter_name ) ) {
				...
				$filters = array_filter( get_option( $filter_name, [ ] ), function ( $item ) {
