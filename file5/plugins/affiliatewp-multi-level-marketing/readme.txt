...
14. Checkout Referrals (Integration)
...
= 1.1.7 =
* NEW - AffiliateWP Affiliate Forms for Gravity Forms integration - Referrer Field.

= 1.1.6 =

* NEW - AffiliateWP Performance Bonuses integration - Team Referrals Bonus Type.
* NEW - AffiliateWP Performance Bonuses integration - Team Earnings Bonus Type.
* NEW - AffiliateWP Performance Bonuses integration - Team Amount Sold Bonus Type.
* NEW - AffiliateWP Ranks integration - Team Referrals Rank Type.
* NEW - AffiliateWP Ranks integration - Team Earnings Rank Type.
* NEW - AffiliateWP Ranks integration - Team Amount Sold Rank Type.
* NEW - Reassign Orphaned Sub Affiliates to Direct Referrer.
* NEW - Direct Affiliate Column in WP Admin Affiliates List.
* NEW - Parent Affiliate Column in WP Admin Affiliates List.
* UPDATE - Run affiliate connection actions during connections update (Edit Affiliate).
* UPDATE - Cycle calculations.
* FIX - Cycle Count would not reset after removing Sub Affiliates.
* FIX - Affiliate Connections not working when using AffiliateWP Checkout Referrals
...
* UPDATE - Improved English Tranlsation.
