...
{"field":"fn_today_join","name":"W_TODAY_JOIN","width":"70px","responsive":"","format":"number"},
{"field":"fn_today_write","name":"W_TODAY_WRITE","width":"70px","responsive":"","format":"number"},
{"field":"fn_today_reply","name":"W_TODAY_REPLY","width":"70px","responsive":"mb-hide-mobile","format":"number"},
{"field":"fn_today_comment","name":"W_TODAY_COMMENT","width":"70px","responsive":"mb-hide-mobile","format":"number"},
{"field":"fn_today_upload","name":"W_TODAY_UPLOAD","width":"70px","responsive":"mb-hide-mobile mb-hide-tablet","format":"number"},
{"field":"fn_today_page_view","name":"W_TODAY_PAGE_VIEW","width":"90px","format":"number"},
{"field":"fn_today_visit","name":"W_TODAY_VISIT","width":"90px","format":"number"},
{"field":"fn_total_visit","name":"W_CUMULATE_VISIT","width":"100px","responsive":"mb-hide-mobile mb-hide-tablet","search":"false","format":"number"}
';
