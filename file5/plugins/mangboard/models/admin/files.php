...
{"field":"fn_file_size","name":"Size","width":"80px","type":"admin_file_size","responsive":"mb-hide-mobile"},
...
if(!function_exists('mbw_board_files_api_body')){
		...
		if(mbw_is_admin()){
			...
			if($query_command=="DELETE"){
				...
				foreach($items as $item){
					if($item[$field["fn_link_count"]]=="0" && !empty($item[$field["fn_file_path"]])){
