...
<script type="text/javascript">
	...
	function showCommentForm(action, pid, idx){
		...
		if(action=="delete"){
			...
			addHtml=addHtml+ '<form name="<?php echo $mb_board_name;?>_form_comment_reply" id="<?php echo $mb_board_name;?>_form_comment_reply" method="post" action="">';
		...
		if(response.state == "success"){
			...
			jQuery.each(response.data, function(key,value){
				...
				if(parseInt(value[fn_reply])>0){
					...
					reply_sign		= '<img class="list-i-reply" alt="reply" src="<?php echo MBW_SKIN_URL;?>images/icon_reply_head.gif" style="vertical-align:top !important;" /> ';
				} else {
					reply_class		= '';
					reply_sign		= '';
				}
	...
	<fieldset>
		...
		<div id="mb_comment_write_box" class="cmt-input-box">
			<div class="cmt-input-head">
				<form name="<?php echo $mb_board_name;?>_form_comment_write" id="<?php echo $mb_board_name;?>_form_comment_write" method="post" action="">
					<?php
