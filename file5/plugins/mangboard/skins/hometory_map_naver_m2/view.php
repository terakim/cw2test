		...
		<div class="btn-box-right" id="<?php echo $mb_board_name;?>_btn_box">
			<?php
				...
				if(mbw_get_board_option("fn_use_board_vote_good") == 1 && isset($mb_fields["select_board"]["fn_vote_good_count"]) ) 
					echo mbw_get_btn_template(array("add_name"=>"<img src='".MBW_SKIN_URL."images/recommendation1.png' style='width:20px;height:20px;' /><span id='".$mb_board_name."_vote_good'>".mbw_get_board_item("fn_vote_good_count")."</span>","onclick"=>"sendBoardViewData('vote_good')","class"=>"btn btn-good btn-vote-good margin-bottom-10"));
					
				if(mbw_get_board_option("fn_use_board_vote_bad") == 1 && isset($mb_fields["select_board"]["fn_vote_bad_count"]))
					echo mbw_get_btn_template(array("add_name"=>"<img src='".MBW_SKIN_URL."images/recommendation2.png' style='width:20px;height:20px;' /><span id='".$mb_board_name."_vote_bad'>".mbw_get_board_item("fn_vote_bad_count")."</span>","onclick"=>"sendBoardViewData('vote_bad')","class"=>"btn btn-bad btn-vote-bad margin-bottom-10"));
				echo '</div>';
