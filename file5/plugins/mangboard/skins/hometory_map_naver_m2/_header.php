...
echo 'mb_urls["skin"]						= "'.MBW_SKIN_URL.'";';
...
echo 'mb_languages["view_details"]		= "'.__MW("W_VIEW_DETAILS").'";';
echo 'mb_languages["ie_address"]		= "'.__MM('MSG_FIELD_EMPTY_ERROR1',__MW("W_ADDRESS")).'";';
echo 'mb_languages["ie_find_location"]			= "'.__MM("MSG_FIND_LOCATION_ERROR").'";';
echo 'mb_languages["ie_current_location"]		= "'.__MM("MSG_CURRENT_LOCATION_ERROR").'";';
?>
