...
<form name="<?php echo $mb_board_name;?>_form_board_write" id="<?php echo $mb_board_name;?>_form_board_write" method="post" enctype="multipart/form-data" autocomplete="off">
...
<div class="mb-style1 board-write">	
