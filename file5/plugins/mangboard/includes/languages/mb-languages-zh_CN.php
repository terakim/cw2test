...
$mb_languages["W_VOTE_GOOD"]		= "推荐";
$mb_languages["W_VOTE_BAD"]			= "不推荐";
...
$mb_languages["W_SHOW_LIST_SEARCH"]	= "搜索功能";
...
$mb_languages["W_LIST_TITLE_LABEL"]	= "使用（可选）,使用（全部）,不使用";
...
$mb_languages["W_EDIT_USER_INFO"]	= "编辑会员信息";
...
$mb_languages["W_ON_OFF2"]				= "使用,禁用";
$mb_languages["W_ON_OFF3"]				= "使用,禁用";
...
$mb_languages["MSG_INSTALL_PERMISSION_ERROR"]			= "您無權安裝";	
$mb_languages["MSG_INSTALL_VERSION_ERROR"]				= "要继续安装，请从网格板仪表板进行更新";	
$mb_languages["MSG_INSTALL_SELECT_PRODUCT"]				= "要安裝所選項目嗎？";
$mb_languages["MSG_DELETE_SELECT_PRODUCT"]				= "你想删除吗？";
$mb_languages["MSG_DELETE_TEXT1"]								= "已被删除";
$mb_languages["MSG_REQUIRED_WORDPRESS_IMPORTER"]	= "需要Wordpress-Importer插件安裝";
$mb_languages["MSG_STORE_MOVE"]									= "商店頁面";
...
$mb_languages["W_MAX_WIDTH"]									= "最大宽度";
$mb_languages["W_ROW_COUNT"]									= "行";
$mb_languages["W_ALIGN"]											= "对齐";
$mb_languages["W_FORM_SUBMIT"]									= "提交";
$mb_languages["MSG_ECOMPOSER_MAX_WIDTH_TITLE"]	= "最大宽度";
$mb_languages["MSG_ECOMPOSER_ROW_COUNT_TITLE"]	= "行数";
$mb_languages["MSG_ECOMPOSER_ALIGN_TITLE"]			= "文字对齐";

$mb_languages["MSG_ECOMPOSER_INSERT_LAYOUT"]		= "将响应式布局插入编辑器";
$mb_languages["MSG_ECOMPOSER_EXPAND_PANELS"]		= "展开面板";
$mb_languages["MSG_ECOMPOSER_COLLAPSE_ICONS"]	= "折叠到图标";

$mb_languages["MSG_ECOMPOSER_INNER_BOX_DESC"]	= "文本框";
$mb_languages["MSG_ECOMPOSER_OUTER_BOX_DESC"]	= "响应盒";
$mb_languages["MSG_ECOMPOSER_WRAP_BOX_DESC"]	= "包装盒";
$mb_languages["MSG_ECOMPOSER_DOTTED_DESC"]		= "以虚线显示的指南仅出现在帖子页面上";

//Board Item
$mb_languages["MSG_SECRET_CONTENT_DISPLAY_ERROR"]	= "机密文章无法显示";
$mb_languages["MSG_PRIVATE_CONTENT_DISPLAY_ERROR"]	= "私人内容无法显示";
$mb_languages["MSG_BOARD_CONTENT_DISPLAY_ERROR"]	= "仅显示普通公告板的内容";
$mb_languages["MSG_BOARD_CONTENT_LEVEL_ERROR"]		= "只能显示列表和查看权限设置为0的公告板";

$mb_languages["MSG_PASSWD_MODIFY"]		= "密码已更正";
$mb_languages["W_SAVE_EXCEL"]				= "保存 Excel";
$mb_languages["MSG_SAVE_EXCEL_DESC"]		= "将搜索或选择的成员保存为 Excel 文件";
$mb_languages["W_VIDEO"]						= "视频";
$mb_languages["W_VIDEO_INSERT"]				= "添加视频";
$mb_languages["MSG_VIDEO_INSERT_ERROR"]	= "请输入视频网址或iframe来源";

$mb_languages["MSG_UPDATE_LATEST_VERSION"]	= "有更新到最新版本 (%s).";
$mb_languages["MSG_UPDATE_CONFIRM2"]			= "您要继续更新吗？";

$mb_languages["W_BG_COLOR"]	= "背景色";

$mb_languages["W_REGION"]					= "地域";
$mb_languages["W_MAP"]						= "地图";
$mb_languages["W_MAP_SEARCH"]			= "搜查";
$mb_languages["W_CLOSE"]					= "关闭";

$mb_languages["W_COORDINATES"]			= "坐标";
$mb_languages["W_LATITUDE"]				= "纬度(Lat)";
$mb_languages["W_LONGITUDE"]			= "经度(Lng)";

$mb_languages["MSG_SEARCH_RESULT"]	= "有%s个搜索结果。";

$mb_languages["W_RESERVED_DATE"]				= "预订日期";
$mb_languages["W_RESERVED_TIME"]				= "预约时间";
$mb_languages["W_NUMBER_OF_PEOPLE"]			= "人数";
$mb_languages["W_APPLY"]							= "申请";

$mb_languages["MSG_PRIVACY_POLICY_TEXT"]		= "我同意收集和使用个人信息";
$mb_languages["MSG_PRIVACY_POLICY_ERROR"]		= "请同意收集和使用个人信息";
?>