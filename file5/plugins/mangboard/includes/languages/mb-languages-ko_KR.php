...
$mb_languages["MSG_PAGE_BLOCK_NUM_SET"]	= "페이지 블럭 개수를 설정합니다, 100으로 설정시 \"더보기\" 버튼 방식으로 변경 / \"더보기\" 버튼 기능은 게시판 기능에서만 사용가능";
$mb_languages["MSG_TITLE_BAR_LIST"]	= "자료실 게시판 목록에서 게시물 상단에 제목바 표시기능에 대한 사용여부를 설정합니다";
...
$mb_languages["MSG_ADMIN_LEVEL_SET"]	= "관리자 레벨 설정(접근권한 기능 및 일부 제한 기능 예외됨)";
...
$mb_languages["W_REPLY_WRITE"]			= "답변 작성";
...
$mb_languages["W_VOTE_GOOD"]					= "추천";
$mb_languages["W_VOTE_BAD"]						= "비추천";
...
$mb_languages["W_AUTO_LOGIN"]				= "로그인 상태유지";
...
$mb_languages["W_SHOW_LIST_SEARCH"]	= "목록 검색 기능";
...
$mb_languages["W_LIST_TITLE_LABEL"]		= "사용(모바일 제외),사용(항상),사용안함";
...
$mb_languages["W_EDIT_USER_INFO"]	= "회원 정보 편집";
...
$mb_languages["W_ON_OFF2"]					= "허용,허용안함";
$mb_languages["W_ON_OFF3"]					= "수신,수신안함";
...
$mb_languages["W_SEARCH_FIELD"]									= "검색 항목";
$mb_languages["W_SEARCH_TEXT"]									= "검색어 입력";
$mb_languages["W_SEO_DEFAULT_IMAGE"]							= "SEO 기본 이미지";
$mb_languages["MSG_SEO_DEFAULT_IMAGE_DESC"]				= "소셜 공유시 대표 이미지가 없을 경우 보여줄 기본 이미지를 선택해 주세요";
$mb_languages["MSG_INSTALL_PERMISSION_ERROR"]			= "플러그인 설치권한이 없습니다";	
$mb_languages["MSG_INSTALL_VERSION_ERROR"]				= "설치를 진행하시려면 망보드 대시보드에서 최신버전으로 업데이트를 진행해 주세요";	

$mb_languages["MSG_INSTALL_SELECT_PRODUCT"]				= "선택하신 상품을 설치하시겠습니까?";
$mb_languages["MSG_DELETE_SELECT_PRODUCT"]				= "선택하신 상품을 삭제하시겠습니까?";
$mb_languages["MSG_DELETE_TEXT1"]								= "정상적으로 삭제되었습니다";
$mb_languages["MSG_REQUIRED_WORDPRESS_IMPORTER"]	= "Wordpress Importer 플러그인 설치가 필요합니다";
$mb_languages["MSG_STORE_MOVE"]									= "스토어 이동하기";

$mb_languages["MSG_FACEBOOK_PIXEL_ID_DESC"]				= "Facebook Pixel 연결 및 망보드 커머스 상품결제에 대한 전환추적 기능, ex) 123456789012345";
$mb_languages["MSG_NAVER_ANALYTICS_ID_DESC"]				= "Naver Analytics 연결 및 망보드 커머스 상품결제에 대한 프리미엄 로그분석 기능, ex) 123a1234567890";
$mb_languages["MSG_GOOGLE_ANALYTICS_ID_DESC"]			= "Google Analytics 연결 및 망보드 커머스 상품결제에 대한 전환추적 기능, ex) UA-1234567-8";

$mb_languages["MSG_NAVER_SITE_VERIFICATION_DESC"]		= "Naver 사이트 등록 및 소유확인을 위한 Naver Site Verification 입력, ex) c230c232cjfd9320234addfjahdfkasdf342kd";
$mb_languages["MSG_GOOGLE_SITE_VERIFICATION_DESC"]		= "Google 사이트 등록 및 소유확인을 위한 Google Site Verification 입력, ex) p0KasdDduAdDgADFG34343H34d3Nd8dHdkuH3aKa";

//Editor Composer
$mb_languages["W_ECOMPOSER_EXCEPT_BOARD"]				= "에디터 컴포저 예외 게시판";
$mb_languages["W_ECOMPOSER_USE_BOARD"]					= "에디터 컴포저 허용 게시판";
$mb_languages["W_ECOMPOSER_USE_LEVEL"]						= "에디터 컴포저 허용 레벨";

$mb_languages["MSG_ECOMPOSER_EXCEPT_BOARD_DESC"]	= "에디터 컴포저(반응형 레이아웃) 기능을 적용하지 않을 게시판 이름을 쉼표로 구분해서 입력";
$mb_languages["MSG_ECOMPOSER_USE_BOARD_DESC"]		= "에디터 컴포저(반응형 레이아웃) 기능을 특정 게시판에만 적용할 경우 해당하는 게시판 이름을 쉼표로 구분해서 입력 (생략시 전체허용)";
$mb_languages["MSG_ECOMPOSER_USE_LEVEL_DESC"]			= "에디터 컴포저(반응형 레이아웃) 기능을 사용할 수 있는 회원 레벨 설정 (설정된 레벨 이상의 회원만 사용 가능)";

$mb_languages["W_MAX_WIDTH"]									= "최대넓이";
$mb_languages["W_ROW_COUNT"]									= "행개수";
$mb_languages["W_ALIGN"]											= "정렬";
$mb_languages["W_FORM_SUBMIT"]									= "등록하기";

$mb_languages["MSG_ECOMPOSER_MAX_WIDTH_TITLE"]	= "레이아웃 최대넓이를 선택합니다";
$mb_languages["MSG_ECOMPOSER_ROW_COUNT_TITLE"]	= "레이아웃 행의 개수를 선택합니다";
$mb_languages["MSG_ECOMPOSER_ALIGN_TITLE"]			= "텍스트 정렬을 선택합니다";

$mb_languages["MSG_ECOMPOSER_INSERT_LAYOUT"]		= "반응형 레이아웃을 에디터에 추가합니다";
$mb_languages["MSG_ECOMPOSER_EXPAND_PANELS"]		= "확장패널 열기";
$mb_languages["MSG_ECOMPOSER_COLLAPSE_ICONS"]	= "확장패널 닫기";

$mb_languages["MSG_ECOMPOSER_INNER_BOX_DESC"]	= "텍스트 박스";
$mb_languages["MSG_ECOMPOSER_OUTER_BOX_DESC"]	= "텍스트 박스를 감싸는 반응형 박스";
$mb_languages["MSG_ECOMPOSER_WRAP_BOX_DESC"]	= "반응형 박스를 감싸는 테두리 박스";
$mb_languages["MSG_ECOMPOSER_DOTTED_DESC"]		= "점선으로 표시되는 안내선은 글작성 페이지에서만 표시됩니다";

//Board Item
$mb_languages["MSG_SECRET_CONTENT_DISPLAY_ERROR"]	= "비밀글의 내용은 표시할 수 없습니다";
$mb_languages["MSG_PRIVATE_CONTENT_DISPLAY_ERROR"]	= "비공개된 내용은 표시할 수 없습니다";
$mb_languages["MSG_BOARD_CONTENT_DISPLAY_ERROR"]	= "일반 게시판의 내용만 표시할 수 있습니다";
$mb_languages["MSG_BOARD_CONTENT_LEVEL_ERROR"]		= "목록 권한과 글보기 권한이 모두 0으로 설정된 게시판 내용만 표시할 수 있습니다";

$mb_languages["MSG_PASSWD_MODIFY"]				= "비밀번호가 수정되었습니다";
$mb_languages["W_SAVE_EXCEL"]						= "Excel 저장하기";
$mb_languages["MSG_SAVE_EXCEL_DESC"]				= "검색 또는 선택된 회원을 Excel 파일로 저장합니다";
$mb_languages["W_VIDEO"]								= "동영상";
$mb_languages["W_VIDEO_INSERT"]						= "동영상 추가";
$mb_languages["MSG_VIDEO_INSERT_ERROR"]		= "동영상 URL 주소 또는 iframe 소스를 입력해주세요";

$mb_languages["MSG_UPDATE_LATEST_VERSION"]	= "최신버전(%s)의 업데이트가 있습니다.";
$mb_languages["MSG_UPDATE_CONFIRM2"]			= "업데이트를 진행하시겠습니까?";


$mb_languages["W_BG_COLOR"]				= "배경색";

$mb_languages["W_REGION"]					= "지역";
$mb_languages["W_MAP"]						= "지도";
$mb_languages["W_MAP_SEARCH"]			= "지도검색";
$mb_languages["W_CLOSE"]					= "닫기";

$mb_languages["W_COORDINATES"]			= "지도 좌표";
$mb_languages["W_LATITUDE"]				= "위도(Lat)";
$mb_languages["W_LONGITUDE"]			= "경도(Lng)";

$mb_languages["MSG_SEARCH_RESULT"]	= "총 %s개의 검색 결과가 있습니다";

$mb_languages["W_RESERVED_DATE"]				= "예약일자";
$mb_languages["W_RESERVED_TIME"]				= "예약시간";
$mb_languages["W_NUMBER_OF_PEOPLE"]			= "인원";
$mb_languages["W_APPLY"]							= "신청하기";

$mb_languages["MSG_PRIVACY_POLICY_TEXT"]		= "개인정보 수집 및 이용 내용에 동의합니다";
$mb_languages["MSG_PRIVACY_POLICY_ERROR"]		= "개인정보 수집 및 이용 내용에 동의해주세요";
?>