...
$mb_languages["MSG_UPDATE_PERMISSION_ERROR"]	= "アップデートに必要な権限がありません。";	
...
$mb_languages["MSG_TITLE_BAR_LIST"]  = "投稿掲示板のリストにタイトルバーを表示するかどうかを設定します。";
...
$mb_languages["MSG_SET_REPLY"]	= "返事権限を設定します。";
...
$mb_languages["MSG_POINT_REPLY"]	= "返事を作成時に与えるポイントを入力します。";
...
$mb_languages["W_EMAIL"]	= "メール";	
$mb_languages["W_IMAGE"]	= "イメージ";	
$mb_languages["W_TITLE"]	= "タイトル";	
$mb_languages["W_USER_NAME"]	= "名前";	
$mb_languages["W_USER_NAME_PID"]	= "名前[Pid]";
$mb_languages["W_WRITER"]	= "名前";
...
$mb_languages["W_REPLY"]		= "返事";	
$mb_languages["W_REPLY_WRITE"]	= "返事を書く";
...
$mb_languages["W_VOTE_GOOD"]		= "推薦";
$mb_languages["W_VOTE_BAD"]			= "非推薦";
...
$mb_languages["W_SHOW_TITLE_BAR"]  = "リストのタイトルバー表示";
$mb_languages["W_SHOW_LIST_SEARCH"]	= "リスト検索機能";
...
$mb_languages["W_LIST_TITLE_LABEL"]	= "使用(選択),使用(全て),使用しない";
...
$mb_languages["W_AUTHORITY_REPLAY"]	= "返事権限";
...
$mb_languages["W_REPLY_POINT"]	= "返事ポイント";
...
$mb_languages["W_EDIT_USER_INFO"]	= "会員情報編集";
...
$mb_languages["W_ON_OFF2"]				= "使用できる,を無効にする";
$mb_languages["W_ON_OFF3"]				= "使用できる,を無効にする";
...
$mb_words["View"]	= "投稿表示";	
$mb_words["Modify"]	= "修正";	
$mb_words["Send_Write"]	= "登録";	//作成画面送信ボタン
$mb_words["Send_Modify"]	= "登録";	//修正画面送信ボタン
$mb_words["Send_Reply"]	= "登録";	//返事画面送信ボタン
...
$mb_languages["MSG_INSTALL_PERMISSION_ERROR"]			= "設置に必要な権限がありません。";	
$mb_languages["MSG_INSTALL_VERSION_ERROR"]				= "インストールを続行するには、網ボードダッシュボードでの更新を進めてください";	
$mb_languages["MSG_INSTALL_SELECT_PRODUCT"]				= "選択された商品をインストールしますか?";
$mb_languages["MSG_DELETE_SELECT_PRODUCT"]				= "削除しますか？";
$mb_languages["MSG_DELETE_TEXT1"]								= "削除されました";
$mb_languages["MSG_REQUIRED_WORDPRESS_IMPORTER"]	= "wordpress-importerのプラグインの設置が必要です。";
$mb_languages["MSG_STORE_MOVE"]									= "ストアページ";
...
$mb_languages["W_MAX_WIDTH"]									= "最大幅";
$mb_languages["W_ROW_COUNT"]									= "行";
$mb_languages["W_ALIGN"]											= "整列";
$mb_languages["W_FORM_SUBMIT"]									= "登録する";
$mb_languages["MSG_ECOMPOSER_MAX_WIDTH_TITLE"]	= "最大幅";
$mb_languages["MSG_ECOMPOSER_ROW_COUNT_TITLE"]	= "行数";
$mb_languages["MSG_ECOMPOSER_ALIGN_TITLE"]			= "テキスト整列";

$mb_languages["MSG_ECOMPOSER_INSERT_LAYOUT"]		= "レスポンシブレイアウトをエディターに挿入する";
$mb_languages["MSG_ECOMPOSER_EXPAND_PANELS"]		= "パネルを展開";
$mb_languages["MSG_ECOMPOSER_COLLAPSE_ICONS"]	= "アイコンに折りたたむ";

$mb_languages["MSG_ECOMPOSER_INNER_BOX_DESC"]	= "テキストボックス";
$mb_languages["MSG_ECOMPOSER_OUTER_BOX_DESC"]	= "レスポンシブボックス";
$mb_languages["MSG_ECOMPOSER_WRAP_BOX_DESC"]	= "ラップボックス";
$mb_languages["MSG_ECOMPOSER_DOTTED_DESC"]		= "点線で表示されるガイドは、投稿ページにのみ表示されます";

//Board Item
$mb_languages["MSG_SECRET_CONTENT_DISPLAY_ERROR"]	= "秘密の記事は表示できません";
$mb_languages["MSG_PRIVATE_CONTENT_DISPLAY_ERROR"]	= "非公開コンテンツは表示できません";
$mb_languages["MSG_BOARD_CONTENT_DISPLAY_ERROR"]	= "一般掲示板のコンテンツのみを表示できます";
$mb_languages["MSG_BOARD_CONTENT_LEVEL_ERROR"]		= "リストおよび表示権限が0に設定された掲示板のみを表示できます";

$mb_languages["MSG_PASSWD_MODIFY"]		= "パスワードが変更されました";
$mb_languages["W_SAVE_EXCEL"]				= "Excel保存";
$mb_languages["MSG_SAVE_EXCEL_DESC"]		= "検索または選択されたメンバーをExcelファイルとして保存します";
$mb_languages["W_VIDEO"]						= "動画";
$mb_languages["W_VIDEO_INSERT"]				= "動画を追加";
$mb_languages["MSG_VIDEO_INSERT_ERROR"]	= "動画のURLアドレスまたはiframeソースを入力してください";

$mb_languages["MSG_UPDATE_LATEST_VERSION"]	= "最新バージョン（%s）のアップデートがあります";
$mb_languages["MSG_UPDATE_CONFIRM2"]			= "アップデートを続行しますか？";

$mb_languages["W_BG_COLOR"]	= "背景色";

$mb_languages["W_REGION"]					= "地域";
$mb_languages["W_MAP"]						= "地図";
$mb_languages["W_MAP_SEARCH"]			= "地図検索";
$mb_languages["W_CLOSE"]					= "閉め";

$mb_languages["W_COORDINATES"]			= "座標";
$mb_languages["W_LATITUDE"]				= "緯度(Lat)";
$mb_languages["W_LONGITUDE"]			= "経度(Lng)";

$mb_languages["MSG_SEARCH_RESULT"]	= "%s個の検索結果があります";

$mb_languages["W_RESERVED_DATE"]				= "予約日時";
$mb_languages["W_RESERVED_TIME"]				= "予約時間";
$mb_languages["W_NUMBER_OF_PEOPLE"]			= "人数";
$mb_languages["W_APPLY"]							= "申し込み";

$mb_languages["MSG_PRIVACY_POLICY_TEXT"]		= "個人情報の収集及び利用内容に同意します";
$mb_languages["MSG_PRIVACY_POLICY_ERROR"]		= "個人情報の収集および利用内容に同意してください";
?>