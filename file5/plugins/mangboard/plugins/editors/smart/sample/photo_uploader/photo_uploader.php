...
<script type="text/javascript" src="<?php echo MBW_PLUGIN_URL."plugins/editors/smart/sample/photo_uploader/";?>jindo.min.js?ver=1.5.1" charset="utf-8"></script>
<script type="text/javascript" src="<?php echo MBW_PLUGIN_URL."plugins/editors/smart/sample/photo_uploader/";?>jindo.fileuploader.js?ver=1.5.1" charset="utf-8"></script>
<script type="text/javascript" src="<?php echo MBW_PLUGIN_URL."plugins/editors/smart/sample/photo_uploader/";?>attach_photo.js?ver=1.5.1" charset="utf-8"></script>
</body>
</html>