    ...
    function html5Upload() {	
		...
		if(opener.parent.mb_urls["ajax_url"]) ajax_url			= opener.parent.mb_urls["ajax_url"];	//mangboard wp edit		
		if(board_name=="" && opener.parent.mb_options["board_name"]) board_name		= opener.parent.mb_options["board_name"];			//mangboard wp edit
 	...
 	function callFileUploader (){
		...
		if(board_name=="" && opener.parent.mb_options["board_name"]) board_name		= opener.parent.mb_options["board_name"];			//mangboard wp edit
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
			...
			sCallback : "../?mb_ext=seditor_callback",	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
