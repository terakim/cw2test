...
/**
 * This constant will be deprecated in version 1.6.25.
 */
define( 'PLUGIN_NAME', 'reviewx');
define( 'REVIEWX_VERSION', '1.6.22' );
...
add_action('plugins_loaded', function () {
	...
	function custom_edit_profile_link($url) {
		if(current_user_can('administration')){
			return $url;
		}
		return site_url( 'my-account/edit-account/' );
	}
	add_filter('edit_profile_url', 'custom_edit_profile_link');