                         ...
                         <td class="woocommerce-orders-table__cell woocommerce-orders-table__cell-<?php echo esc_attr( $column_id ); ?>" data-title="<?php echo esc_attr( $column_name ); ?>">
                             <?php
                                ...
                                elseif ( 'order-number' === $column_id ) : ?>
                                     <p><a href="<?php echo esc_url( $order_url ); ?>"><?php echo esc_html__( '#', 'reviewx' ) . $order->get_order_number(); ?></a></p>
                                ...
                                elseif ( 'order-actions' === $column_id ) :
                                    ...
                                    if ( ! empty( $actions ) ) {
                                        foreach ( $actions as $key => $action ) { // phpcs:ignore WordPress.WP.GlobalVariablesOverride.OverrideProhibited
                                            echo '<p class="padding_5"> <a href="' . esc_url( $action['url'] ) . '" class="rx_my_account_view_review rx-btn btn-primary btn-sm rx-form-primary-btn btn-review review-off btn-info  ' . sanitize_html_class( $key ) . '">' . esc_html__( $action['name'], 'reviewx' ) . '</a> </p>';
                                        }
                                    }
                                    ...
                                    if( $check_already_reviewed ) { ?>
                                        ...
                                        <?php
                                            ...
                                            if ( in_array( $check_order_status, $reviewx_order_status ) ) {
                                                $image = is_array( $attachment ) ? esc_url($attachment[0]) : "";
                                                echo '<p class="padding_5">
                                                    <a class="rx_my_account_submit_review rx-btn btn-primary btn-sm rx-form-primary-btn btn-review review-on btn-info rx-order-btn " 
                                                        ...
                                                        data-product_img="'.esc_url( $image ).'"
