...
if( !isset( $_GET[ 'rtwwwap_tab' ] ) || ( isset( $_GET[ 'rtwwwap_tab' ] ) && $_GET[ 'rtwwwap_tab' ] == 'overview' ) ){
	...
	$rtwwwap_html1 .= 			sprintf( '<span>%s%01.'.$rtwwwap_decimal_places.'</span> %s', $rtwwwap_currency_sym, ( $rtwwwap_total_comm ) ? $rtwwwap_total_comm : '0', esc_html__( 'Total Commission', 'rtwwwap-wp-wc-affiliate-program' ) );
	$rtwwwap_html1 .= 		'</div>';
	$rtwwwap_html1 .= 		'<div class="rtwwwap-overview-box" id="rtwwwap_wallet">';
	$rtwwwap_html1 .= 			sprintf( '<span>%s%01.'.$rtwwwap_decimal_places.'</span> %s', $rtwwwap_currency_sym, ( $rtwwwap_wallet ) ? $rtwwwap_wallet : '0', esc_html__( 'Wallet', 'rtwwwap-wp-wc-affiliate-program' ) );
	$rtwwwap_html1 .= 		'</div>';
	$rtwwwap_html1 .= 		'<div class="rtwwwap-overview-box" id="rtwwwap_approved_commission">';
	$rtwwwap_html1 .= 			sprintf( '<span>%s%01.'.$rtwwwap_decimal_places.'</span> %s', $rtwwwap_currency_sym, ( $rtwwwap_approved_comm ) ? $rtwwwap_approved_comm : '0', esc_html__( 'Approved Commission', 'rtwwwap-wp-wc-affiliate-program' ) );
	$rtwwwap_html1 .= 		'</div>';
	$rtwwwap_html1 .= 		'<div class="rtwwwap-overview-box" id="rtwwwap_pending_commission">';
	$rtwwwap_html1 .= 			sprintf( '<span>%s%01.'.$rtwwwap_decimal_places.'</span> %s', $rtwwwap_currency_sym, ( $rtwwwap_pending_comm ) ? $rtwwwap_pending_comm : '0', esc_html__( 'Pending Commission', 'rtwwwap-wp-wc-affiliate-program' ) );
	$rtwwwap_html1 .= 		'</div>';
	$rtwwwap_html1 .= 	'</div>';
	...
	if( $rtwwwap_total_referrals ){
		...
		foreach( $rtwwwap_user_all_referrals as $rtwwwap_user_ref_key => $rtwwwap_user_ref_value ){
			...
			if( RTWWWAP_IS_WOO == 1 ){
				$rtwwwap_html1 .= 			esc_html( get_woocommerce_currency_symbol( $rtwwwap_user_ref_value[ 'currency' ] ).$rtwwwap_user_ref_value[ 'amount' ] );
			}
			else{
				$rtwwwap_html1 .= 			esc_html( $rtwwwap_curr_obj->rtwwwap_curr_symbol( $rtwwwap_user_ref_value[ 'currency' ] ).$rtwwwap_user_ref_value[ 'amount' ] );
			}
			$rtwwwap_html1 .= 			'</td>';
			$rtwwwap_html1 .= 			'<td>';
			...
			if( $rtwwwap_user_ref_value[ 'capped' ] == '0' ){
				...
				elseif( $rtwwwap_user_ref_value[ 'status' ] == 3 ){
					...
					if($rtwwwap_user_ref_value[ 'message' ] != ''){
						...
						$rtwwwap_html1 .=       '<p class="test"><a class="rtwbma_edit_apntmnt" rel="modal:open" href="#rtwbma_popup_'.$rtwwwap_user_ref_value[ 'id' ].'">'.esc_html__( 'View Reason', 'rtwwwap-wp-wc-affiliate-program' ).'</a> </p>';
						$rtwwwap_html1 .=       '<div> ';
						$rtwwwap_html1 .=  			'<div id="rtwbma_popup_'.$rtwwwap_user_ref_value[ 'id' ].'" class="modal ">';
						$rtwwwap_html1 .=  				'<div class="rtwwwap_modal-content">';
						$rtwwwap_html1 .=			'<a href="javascript:void(0);" rel="modal:close" class="rtwbma_close">'. esc_html__( "&#10060;", "rtwbma-book-my-appointment" ).'</a>';
						$rtwwwap_html1 .=  						'<p>';
...
if( isset( $_GET[ 'rtwwwap_tab' ] ) && $_GET[ 'rtwwwap_tab' ] == 'commissions' ){
	...
	$rtwwwap_html1 .= 	'<div class="rtwwwap_table_wrapper"><table id="rtwwwap_commission">';
		...
		if( $rtwwwap_comm_base == 1 ){
			foreach( $rtwwwap_commissions as $rtwwwap_key => $rtwwwap_value ){
				if( $rtwwwap_key == 'all_commission' ){
					$rtwwwap_html1 .= 	'<caption class="rtwwwap_commissionws_wrapper">';
			...
			if( !empty( $rtwwwap_levels_settings ) )
			{
				...
				foreach( $rtwwwap_levels_settings as $rtwwwap_levels_key => $rtwwwap_levels_val )
				{
					...
					{
						$rtwwwap_html1 .= sprintf( '%s%01.'.$rtwwwap_decimal_places, $rtwwwap_currency_sym, esc_html( $rtwwwap_levels_val[ 'level_comm_amount' ] ) );
					}
					$rtwwwap_html1 .= 			'</td>';
					...
					{
						$rtwwwap_html1 .= sprintf( '%s', esc_html__( 'Become Affiliate' , 'rtwwwap-wp-wc-affiliate-program'  ));
					}
					elseif( $rtwwwap_levels_val[ 'level_criteria_type' ] == 1 )
					{
						$rtwwwap_html1 .= sprintf( '%s %s', esc_html__( 'No. of referrals', 'rtwwwap-wp-wc-affiliate-program'  ), esc_html__( $rtwwwap_levels_val[ 'level_criteria_val' ] ) );
					}
					elseif( $rtwwwap_levels_val[ 'level_criteria_type' ] == 2 )
					{
						$rtwwwap_html1 .= sprintf( '%s %s%01.'.$rtwwwap_decimal_places, esc_html__( 'Total sale amount' , 'rtwwwap-wp-wc-affiliate-program' ), $rtwwwap_currency_sym, esc_html__( $rtwwwap_levels_val[ 'level_criteria_val' ] ) );
						;
					}
					$rtwwwap_html1 .= 			'</td>';
					$rtwwwap_html1 .= 		'</tr>';
...
if( isset( $_GET[ 'rtwwwap_tab' ] ) && $_GET[ 'rtwwwap_tab' ] == 'affiliate_tools' ){
	...
	if( $rtwwwap_social_share_setting === 'on' ){
		...
		$rtwwwap_html1 .=	  			'<a class="twitter-share-button rtwwwap_twitter rtwwwap_share_text_color" href="javascript:void(0);">';
	...
	$rtwwwap_html1 .=	  		'<span class="rtwwwap-search-icon" id="rtwwwap_search_button">';
	$rtwwwap_html1 .= 				'<i class="fa fa-search" ></i>';
	$rtwwwap_html1 .=	  		'</span>';
	$rtwwwap_html1 .=	  	'</div>';
	$rtwwwap_html .= 		'<div class="rtwwwap-product-listing-row">';
...
if( isset( $_GET[ 'rtwwwap_tab' ] ) && $_GET[ 'rtwwwap_tab' ] == 'download' ){
	...
	if( isset( $_GET[ 'rtwwwap_tab' ] ) && $_GET[ 'rtwwwap_tab' ] == 'payout' ){
		...
		$rtwwwap_wallet   			= (isset($rtwwwap_wallet) && !empty($rtwwwap_wallet)) ?  $rtwwwap_wallet : 0;
		...
		$rtwwwap_html1 .= 	'<div id="rtwwwap_payment-section">';
		$rtwwwap_html1 .= 	'<div id="rtwwwap_payment-box">';
		$rtwwwap_html1 .= 		'<h3>'.esc_html__( "Payout", "rtwwwap-wp-wc-affiliate-program" ).'</h3>';
	
		if( $rtwwwap_comm_base == 2 && $rtwwwap_level_name != '' ){
			$rtwwwap_html1 .= 		'<div id="rtwwwap_email_settings">';
			$rtwwwap_html1 .= 		'<div id="rtwwwap_email_setting">';
			$rtwwwap_html1 .= 			'<h4 class="rtwwwap_setting_span">'.esc_html__( "Your Affiliate Level : ", "rtwwwap-wp-wc-affiliate-program" ).'</h4>';
			$rtwwwap_html1 .= 			'<span class="rtwwwap-span-text">'.esc_html( $rtwwwap_level_name ).'</span>';
			$rtwwwap_html1 .= 		'<div class="progress">
									<div class="rtwwwap-affiliate-progress-bar rtwwwap-progress-bar" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">
			...
			$rtwwwap_html1 .= 		'</div>';
			$rtwwwap_html1 .= 		'<div id="rtwwwap_email_setting">';
			$rtwwwap_html1 .= 			'<h4 class="rtwwwap_setting_span">'.esc_html__("Your Level Commission : ", "rtwwwap-wp-wc-affiliate-program").'</h4>';
			$rtwwwap_html1 .= 			'<span class="rtwwwap-span-text">'.sprintf( '%s%s', esc_html( $rtwwwap_level_comm ), esc_html( $rtwwwap_level_comm_type ) ).'</span>';
			$rtwwwap_html1 .= 		'<div class="progress">
										<div class="rtwwwap-commission-progress-bar rtwwwap-progress-bar" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">
											<span class="sr-only">30% Complete</span>
											</div>
										</div>';
			$rtwwwap_html1 .= 		'</div>';
		...
		$rtwwwap_html1 .= 		'<div id="rtwwwap_email_setting">';
		$rtwwwap_html1 .= 			'<span class="rtwwwap_payout_setting_span">'.esc_html__( "Activate Referral Emails : ", "rtwwwap-wp-wc-affiliate-program" ).'</span>';
		...
		$rtwwwap_html1 .= 			'<label class="rtwwwap-payout-label">'.esc_html__( "Select payment method ", "rtwwwap-wp-wc-affiliate-program" ).'</label>';
			...
			foreach ($rtwwwap_reg_custom_fields as $custom_fields) {
				...
				if(isset($custom_fields['custom-input-type'])){
					if(($custom_fields['custom-input-type'] == 'text' || $custom_fields['custom-input-type'] == 'number')){
						$rtwwwap_html .= 	'<div class="rtwwwap-register-input-group">
						<input type="'.$custom_fields['custom-input-type'].'" name="'.$custom_fields['custom-input-id'].'"  id="'.$custom_fields['custom-input-id'].'" class="'.$custom_fields['custom-input-class'].'" value="'.$rtwwwap_reg_user_custom_field.'" />
						<label>'.esc_html__( $custom_fields['custom-input-label'], "rtwwwap-wp-wc-affiliate-program" ).'</label>
						<span class="rtwwwap-input-highlight"></span>
						<span class="rtwwwap-input-bar"></span>
						</div>';
					}elseif ($custom_fields['custom-input-type'] == 'textarea') {
						
						$rtwwwap_html .=	'<div class="rtwwwap-text">';
						$rtwwwap_html .= 					'<label>'.esc_html__( $custom_fields['custom-input-label'], "rtwwwap-wp-wc-affiliate-program" ).'</label>';
					
						$rtwwwap_html .=  '<textarea name="'.$custom_fields['custom-input-id'].'"  id="'.$custom_fields['custom-input-id'].'" class="'.$custom_fields['custom-input-class'].'" placeholder="'.esc_attr__( $custom_fields['custom-input-label'], "rtwwwap-wp-wc-affiliate-program" ).'">'.$rtwwwap_reg_user_custom_field.'
						</textarea>';
						$rtwwwap_html .=  '</div>';
						$rtwwwap_html .=  '</div>';
						...
						if(is_array($rtwwwap_checkbox_options) && !empty($rtwwwap_checkbox_options)){
							...
							foreach ($rtwwwap_checkbox_options as $value) {
								...
								$rtwwwap_html .= 	'<input type="'.$custom_fields['custom-input-type'].'" name="'.$value.'"  id="'.$custom_fields['custom-input-id'].'" class="'.$custom_fields['custom-input-class'].'" placeholder="'.esc_attr__( $custom_fields['custom-input-label'], "rtwwwap-wp-wc-affiliate-program" ).'"" value="'.esc_attr__(trim($value),"rtwwwap-wp-wc-affiliate-program").'" '.checked($rtwwwap_value_checked,$value,false). ' />'.esc_html__($value,"rtwwwap-wp-wc-affiliate-program");
					...
					elseif ($custom_fields['custom-input-type'] == 'select') {
						...
						if(is_array($rtwwwap_checkbox_options) && !empty($rtwwwap_checkbox_options)){
							$rtwwwap_html .= 	'<div class="rtwwwap-text">';
							$rtwwwap_html .= 	'<label class="select-label">'.esc_html__( $custom_fields['custom-input-label'], "rtwwwap-wp-wc-affiliate-program" ).'</label>';
							$rtwwwap_html .=  '<select name="'.$custom_fields['custom-input-id'].'"  id="'.$custom_fields['custom-input-id'].'" class="'.$custom_fields['custom-input-class'].'" >';
...
if( isset( $_GET[ 'rtwwwap_tab' ] ) && $_GET[ 'rtwwwap_tab' ] == 'profile' ){
	...
	$rtwwwap_html1 = '';
	$rtwwwap_html1 = 	'<form method="post">';
    $rtwwwap_html1 .= 	'<div id="rtwwwap_profile_section">';
    $rtwwwap_html1 .= 	'<div id="rtwwwap_profile_inner_div">';
	$rtwwwap_html1 .= 		'<h3>'.esc_html__( "Profile", "rtwwwap-wp-wc-affiliate-program" ).'</h3>';
    $rtwwwap_html1 .= '<div class="rtwwwap-register-input-group">' ;   
	$rtwwwap_html1 .=  '<input type="text"  disabled value="'.$rtwwwap_userdata['nickname'][0].'">';
	$rtwwwap_html1 .= '<label>Username</label>';
    $rtwwwap_html1 .= '<span class="rtwwwap-input-highlight"></span>';
    $rtwwwap_html1 .= '<span class="rtwwwap-input-bar"></span>';
 	$rtwwwap_html1 .= '</div>';

    $rtwwwap_html1 .= '<div class="rtwwwap-register-input-group">' ;   
    $rtwwwap_html1 .=  '<input type="text"   value="'.$rtwwwap_user->user_email.'" disabled>';	
	$rtwwwap_html1 .= '<label>Email</label>';
	$rtwwwap_html1 .= '<span class="rtwwwap-input-highlight"></span>';
    $rtwwwap_html1 .= '<span class="rtwwwap-input-bar"></span>';
	$rtwwwap_html1 .= '</div>';

    $rtwwwap_html1 .= '<div class="rtwwwap-register-input-group">' ;   
    $rtwwwap_html1 .=  '<input type="text" name="first_name"  value="'.$rtwwwap_userdata['first_name'][0].'">';
	$rtwwwap_html1 .= '<label>First Name</label>';
	$rtwwwap_html1 .= '<span class="rtwwwap-input-highlight"></span>';
    $rtwwwap_html1 .= '<span class="rtwwwap-input-bar"></span>';
	$rtwwwap_html1 .= '</div>';
	  
    $rtwwwap_html1 .= '<div class="rtwwwap-register-input-group">' ;   
    $rtwwwap_html1 .=  '<input type="text" name="last_name" value="'.$rtwwwap_userdata['last_name'][0].'">';
	$rtwwwap_html1 .= '<label>Last Name</label>';
	$rtwwwap_html1 .= '<span class="rtwwwap-input-highlight"></span>';
    $rtwwwap_html1 .= '<span class="rtwwwap-input-bar"></span>';	
  	$rtwwwap_html1 .= '</div>';
    ...
    $rtwwwap_html1 .= 	'<div>';
	$rtwwwap_html1 .= 		'<div><input type="submit" class="rtwwwap_profile_save_btn" value="'.esc_html__( "Update Details", "rtwwwap-wp-wc-affiliate-program" ).'" id="rtwwwap_profile_save" name="rtwwwap_profile_save"><input type="button" class="rtwwwap_profile_change_psw" value="'.esc_html__( "Change password", "rtwwwap-wp-wc-affiliate-program" ).'" id="rtwwwap_change_psw" name="rtwwwap_profile_save"></div>';
