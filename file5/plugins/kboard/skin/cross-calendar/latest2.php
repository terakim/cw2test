<div id="kboard-cross-calendar-latest">
	<table class="kboard-calendar-table2">
		<thead>
			<tr>
			...
			<tr>
				<td class="kboard-latest-title">
					<a href="<?php echo esc_url($url->getDocumentURLWithUID($content->uid))?>">
						<div class="kboard-cross-calendar-cut-strings">
							<?php if($content->isNew()):?><span class="kboard-cross-calendar-new-notify">N</span><?php endif?>
