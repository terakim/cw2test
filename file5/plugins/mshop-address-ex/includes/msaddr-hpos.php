...
final class MSADDR_HPOS {
	...
	static function get_shop_order_screen( $order_type = 'shop_order' ) {
		return MSADDR_HPOS::enabled() ? wc_get_page_screen_id( str_replace( '_', '-', $order_type ) ) : $order_type;
	}
	static function get_order_admin_screen(){
		return MSADDR_HPOS::enabled() ? OrderUtil::get_order_admin_screen() : '';
	}
}
